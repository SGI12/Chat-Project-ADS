...
//        }
        ...
        div.innerHTML='<div class="popup-box popup-box-on chat-popup" id="'+chat_friend+'01">\
                        ...
                        <div class="popup-head-left pull-left">Чат </div>\
                        <div class="popup-head-right pull-right">\
                        <div class="btn-group">\
                        <button class="chat-header-button" data-toggle="dropdown" type="button" aria-expanded="false">\
                        <i class="glyphicon glyphicon-cog"></i> </button>\
                        <ul role="menu" class="dropdown-menu pull-right">\
                        <li><a href="#">К Авторизации</a></li>\
                        </ul>\
                        </div>\
                        ...
                        <textarea id="status_message" placeholder="Введите сообщение..." rows="10" cols="40" ng-model="message" my-enter="send_message(\''+chat_friend+'\',\'{{message}}\')"></textarea>\
                        </div>\
                        </div>';
        $compile(div)($scope);
